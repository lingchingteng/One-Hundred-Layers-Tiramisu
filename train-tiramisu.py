...
# tiramisu.load_weights(
#     "weights/prop_tiramisu_weights_67_12_func_10-e5_decay.best.hdf5")
...
tiramisu.save_weights(
    'weights/prop_tiramisu_weights_67_12_func_10-e7_decay%d.hdf5' % (
        nb_epoch))
